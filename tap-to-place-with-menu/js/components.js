const changeColorComponent = {
  init() {
    ...
    // default: white, dark blue, orange, blue, yellow
    const colorList = ['#FFF', '#091F40', '#FF4713', '#43BBD1', '#FFC758']
...
const annotationComponent = {
  ...
  init() {
    ...
    let labelActivated, hsActivated
...
export {changeColorComponent, annotationComponent, absPinchScaleComponent, proximityComponent, gltfMorphComponent}
